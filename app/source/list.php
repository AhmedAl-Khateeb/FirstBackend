...
if(isset($_GET['delete'])) {
    ...
    $delete = "DELETE FROM `soures` WHERE id=$id";

    $d = mysqli_query($conn , $delete);

    path('soures/list.php');
}
...
<div class="card">
  <div class="card-body">
    <h1 class="card-title text-center">List Source</h1>
    ...
    <table class="table table-striped">
      ...
      <?php foreach($allData as $item) :?>
        <tr>
          ...
          <td class="text-center"> <a href="<?=url("app/source/update.php?edit=") . $item['id'] ?>"> <i title="Edit" class="bx bxs-message-square-edit"></i> </a> </td>
