...
<div class="card">
  <div class="card-body">
    <h1 class="card-title text-center">List Admins</h1>
    ...
    <table class="table table-striped">
        ...
        <tr>
          ...
          <th class="text-center bg-dark text-white">Password</th>
      ...
      <?php foreach($allData as $item) :?>
        <tr>
          ...
          <td class="text-center"> <a href="<?=url("app/admins/update.php?edit=") . $item['id'] ?>"> <i title="Edit" class="bx bxs-message-square-edit"></i> </a> </td>
